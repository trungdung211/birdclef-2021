...
train_df = pd.read_csv("../../input/birdclef-2022/train_metadata_new.csv")
labels = json.load(open("../../input/birdclef-2022/LABEL_IDS.json"))

# target_columns = labels.keys()
# bird2id = {b: i for i, b in enumerate(target_columns)}
# id2bird = {i: b for i, b in enumerate(target_columns)}
bird2id = labels
id2bird = {i: b for b, i in labels.items()}
...
class BirdClef2021Dataset(Dataset):
    def __init__(
        self,
        data_path: str = "../../input/birdclef-2022/train_audio",
        period: float = 15.0,
